...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        // Allows for count. games
        boolean doYouWantToPlay = true;
        while (doYouWantToPlay) {
            System.out.println("Welcome to Tic Tac Toe! \n You must pick what character you want "
                    + "to be and which character i will be");
            System.out.println();
            ...
            System.out.println("Now we can start the game. To play, enter a number "
                    ...
                    + "from 1-9, left to right, up to bottom. We shall see who will win this round.");
